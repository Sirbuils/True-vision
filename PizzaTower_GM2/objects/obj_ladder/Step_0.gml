if (place_meeting(x, y - 1, obj_player1))
{
	with (obj_player1)
	{
		if (place_meeting(x, y + 1, obj_ladder) && !place_meeting(other.x + 16, y + 1, obj_solid) && key_down && ladderbuffer <= 0 && (state == states.crouch || ((character == "S" || character == "M" || char == "S") && (state == states.normal || state == states.mach1))) && place_meeting(x, y + 1, obj_platform))
		{
			y += 5;
			state = states.ladder;
			x = other.x + 16;
